...
odoo.define('web_theme.MenuSearchMixin', function (require) {
    "use strict";
    ...
    const MenuSearchMixin = {
        ...
        _searchMenus() {
            ...
            this.$search_results.html(QWeb.render("web_theme.MenuSearchResults", {
                results: results,
                widget: this,
            }));
        },
        _onSearchResultsNavigate(event) {
            ...
            const all = this.$search_results.find(".ag_menu_search_result");
